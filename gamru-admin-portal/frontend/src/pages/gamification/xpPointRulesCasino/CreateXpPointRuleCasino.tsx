...
import { xpPointRulesCasinoSteps } from './steps';

const api = gamificationApi('xp-point-rules-casino');
const LIST_PATH = '/gamification/xp-point-rules-casino';
const BREADCRUMB = ['Home', 'Gamification', 'XP Point Rules (Casino)'];

const CreateXpPointRuleCasino: FC = () => {
...
export default CreateXpPointRuleCasino;
