...
const SportsCatalogTournametsTableList: FC<SportsCatalogTournamentsTableListProps> = ({
  isCreateModalOpen,
  onCreateModalClose,
}) => {
  ...
  const [formErrors, setFormErrors] = useState<SportsCatalogTournamentsFormErrors>({});
  ...
  const validate = (): boolean => {
    const errs: SportsCatalogTournamentsFormErrors = {};
...
export default SportsCatalogTournametsTableList;
