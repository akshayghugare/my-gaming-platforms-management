...
interface CreateSportsCatalogTournamentsProps {
  isOpen: boolean;
  closeModal: () => void;
  form: SportsCatalogMarketsFormData;
  setForm: Dispatch<SetStateAction<SportsCatalogMarketsFormData>>;
  errors: SportsCatalogMarketsFormErrors;
  onSave: () => void;
  loading: boolean;
...
const CreateSportsCatalogMarket: FC<CreateSportsCatalogTournamentsProps> = ({
  isOpen,
  closeModal,
  form,
  setForm,
    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-xl font-bold text-white">{editId ? 'Edit Market' : 'New Market'}</h2>
          <button
            onClick={closeModal}
...
export default CreateSportsCatalogMarket;
