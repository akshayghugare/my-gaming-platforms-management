...
interface CreateSportsCatalogTournamentsProps {
  isOpen: boolean;
  closeModal: () => void;
  form: SportsCatalogTournamentsFormData;
  setForm: Dispatch<SetStateAction<SportsCatalogTournamentsFormData>>;
  errors: SportsCatalogTournamentsFormErrors;
  onSave: () => void;
  loading: boolean;
...
const CreateSportCatalogTournaments: FC<CreateSportsCatalogTournamentsProps> = ({
  isOpen,
  closeModal,
  form,
  setForm,
...
export default CreateSportCatalogTournaments;
