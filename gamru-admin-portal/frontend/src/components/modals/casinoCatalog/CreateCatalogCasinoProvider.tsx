...
interface CreateCatalogCasinoProviderProps {
  isOpen: boolean;
  closeModal: () => void;
  form: CasinoCatalogProviderFormData;
  setForm: Dispatch<SetStateAction<CasinoCatalogProviderFormData>>;
  errors: CasinoCatalogProviderFormErrors;
  onSave: () => void;
  loading: boolean;
...
const CreateCatalogCasinoProvider: FC<CreateCatalogCasinoProviderProps> = ({
  isOpen,
  closeModal,
  form,
  setForm,
...
export default CreateCatalogCasinoProvider;
